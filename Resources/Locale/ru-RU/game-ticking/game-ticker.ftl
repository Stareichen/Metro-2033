...
game-ticker-player-join-game-message = Добро пожаловать на Станцию Метро 2033! Если вы играете впервые, обязательно нажмите ESC на клавиатуре и прочитайте правила игры, а также не бойтесь просить помощи в "Админ помощь".
game-ticker-get-info-text =
    Привет и добро пожаловать в [color=white]Metro 2033![/color]
...
game-ticker-get-info-preround-text =
    Привет и добро пожаловать в [color=yellow]Metro 2033![/color]
    Текущий раунд: [color=white]#{ $roundId }[/color]
    Текущее количество выживших: [color=white]{ $playerCount }[/color] ([color=white]{ $readyCount }[/color] { $readyCount ->
        [one] готов
       *[other] готовы
    })
    Текущая карта: [color=white]{ $mapName }[/color]
...
player-join-message = Выживший { $name } зашёл!
player-first-join-message = Выживший { $name } зашёл на станцию метро впервые.
# Displayed in chat to admins when a player leaves
player-leave-message = Выживший { $name } вышел!
...
latejoin-arrival-announcement-special = { $job } { $character } проснулся !
